...
namespace YouTube.Controllers
{
    ...
    //[ApiController]
    public class VideoapiController : ApiController //ApiController
    {
        ...
        public IHttpActionResult GetAllVideos()
        {
            ...
            foreach (DataRow item in table.Rows)
            {
                ...
                //usr.Posts.Add(post);
                posts.Add(new Post() { PostTitle = item["post_title"].ToString(), Post_Type = PostType.Video,  PostPath = item["postpath"].ToString() });
            }
